...
# Copy the model file
COPY artifacts/requirements.txt artifacts/config.properties artifacts/entrypoint.sh /home/model-server/
...
RUN chown -R model-server:model-server /home/model-server/ && chmod +x /home/model-server/entrypoint.sh && \
pip install --no-cache-dir -r /home/model-server/requirements.txt
