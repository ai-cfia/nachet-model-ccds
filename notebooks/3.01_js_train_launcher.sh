...
# screen -dmS "train1" bash -c "./notebooks/shell/3.02_js_train_15spp_6_seed_zoom_220250130.sh"
# sleep 60
...
# sleep 60
# screen -dmS "train1" bash -c "./notebooks/shell/3.02_js_train_15spp_1_seed_zoom_120250130.sh"
