...
python nachetmodel/HFTrainer.py \
    ...
    --resume_from_checkpoint models/15spp_zoom_level_validation_models/1seed_model/checkpoint-6500 \
    --learning_rate 0.000002 \
    --overwrite_output_dir True \
>> models/15spp_zoom_level_validation_models/1seed_model/Train_Logs.txt
