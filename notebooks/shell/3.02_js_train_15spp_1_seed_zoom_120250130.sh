...
python nachetmodel/HFTrainer_js.py \
    ...
    --output_dir models/15spp_zoom_level_validation_models/1_seed_model_120250130 \
    --do_train True \
    ...
    --overwrite_output_dir True \
    --seed 2438 \
>> models/15spp_zoom_level_validation_models/1_seed_model_120250130/train_log.txt
