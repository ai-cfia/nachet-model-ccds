...
python nachetmodel/HFTrainer.py \
    --train_dir data/processed/15spp_zoom_level_validation_models/1-seed/train \
    --output_dir models/15spp_zoom_level_validation_models/1_seed_model_20250129 \
    --do_train True \
...
>> models/15spp_zoom_level_validation_models/1_seed_model_20250129/train_log.txt
